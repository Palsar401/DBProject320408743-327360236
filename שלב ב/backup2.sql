...
prompt Created by 97254 on יום שלישי 23 יולי 2024
set feedback off
set define off
...
alter table REPAIR disable constraint MECHANIC_FK;
alter table REPAIR disable constraint VEHICLE_FK;
...
alter table REPAIR enable constraint MECHANIC_FK;
alter table REPAIR enable constraint VEHICLE_FK;
